...
# -*- coding: utf-8 -*-
"""
Created on Thu Aug  6 00:31:35 2020

@author: jordanmiracle
"""
"""
...
class Calendar(object):
    ...
    def __str__(self):
        if Calendar.date_style == "British":
            return "{0:02d}/{1:02}/{2:4d}".format(self.__days,
                                                  self.__months,
                                                  self.__years)
...
if __name__ == "__main__":
    x = Calendar(31, 12, 2020)
    print(x, end=" ")
    x.advance()
    print("after applying advance: ", x)
    print("2020 is a leapyear: ")
    x = Calendar(28, 2, 2020)
    print(x, end=" ")
    x.advance()
    print("after applying advance: ", x)
    x = Calendar(28, 2, 2021)
    print(x, end=" ")
    x.advance()
    print("after applying advance: ", x)
